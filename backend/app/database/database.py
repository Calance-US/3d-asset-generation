...
# Prompt operations
def get_prompts(db, subject: str = None, category: str = None, tag: str = None, search: str = None):
...
def delete_prompt(db: sessionmaker, prompt_id: int) -> bool:
    """
    ...
    try:
        ...
        # Update FAISS index
        get_prompt_selector().update_index()
